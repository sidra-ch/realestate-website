...
const Properties = () => {
  ...
  const { darkMode, toggleDarkMode } = useDarkMode(); // Fixed typo

  return (
    <div className={`${darkMode ? "dark bg-black" : "light bg-gray-200"}`}>
      <section
        id="properties"
      ...
      >
        <div className="flex flex-col justify-center items-start gap-4">
          <h1
            data-aos="zoom-in"
            className="text-black font-black text-2xl  dark:text-slate-600"
          >
            PROPERTIES
          </h1>
          <h1
        ...
        >
          {property.map((item, index) => (
            <div
              ...
              data-aos-delay="200"
              key={index}
              className="bg-gray-200 text-white dark:bg-black rounded-xl w-full" // Fixed dark mode background
            >
              <div
                id="image-box"
              ...
              >
                <div id="top" className="flex justify-between items-end w-full">
                  <div>
                    <button className="px-3 py-2 bg-red-600 hover:bg-white hover:text-black text-white rounded-full text-[13px]">
                      Featured
                    </button>
                  </div>
                ...
                >
                  <div className="flex justify-start items-center gap-2">
                    ...
                    <h1 className="text-white">{item.adress}</h1>
                  </div>
              ...
              <div className="px-6 py-3 flex flex-col justify-center items-start gap-2 w-full">
                ...
                <h1 className="text-2xl text-red-600 font-semibold dark:text-red-500">
                  {item.price}
                </h1>
                <p className="text-xl text-red-500 font-semibold dark:text-white">
                  {item.about}
                </p>
                <div
                  id="icons"
                ...
                >
                  ...
                  <div className="flex justify-center items-center gap-4">
                    <div className="p-2 border-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scale-105 transition-transform duration-300">
