    ...
    <div className={`${darkMode ? "bg-black" : " bg-transparent"}`}>
      ...
      >
        <div className="flex flex-col justify-center items-start gap-4">
          ...
          <h1
            data-aos="zoom-in"
            className="text-white dark:text-slate-600 text-[40px] font-semibold leading-10"
          >
            What our clients <br />
            saying about us
          </h1>
        ...
        <div
          id="clients-box"
          className="grid lg:grid-cols-3 grid-cols-1 justify-center gap-8 items-center w-full"
        >
          {client.map((item, index) => (
            ...
            >
              <div className="flex justify-start items-center w-full gap-4">
                <img
                  src={item.image}
                  className="w-[70%] h-[70%] rounded-full object-cover transform hover:scale-110 transition-transform duration-300"
                  alt=""
                />
              ...
              <p className="text-red-500 text-md text-justify dark:text-white">
                {item.feedback}
              </p>
