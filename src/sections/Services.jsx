  ...
  return (
    ...
    >
      <button
        ...
        className="fixed top-4 right-4 p-2 bg-red-500 text-white rounded-lg"
      >
        Toggle Dark Mode
      </button>
      ...
      >
        <div className="flex flex-col justify-center items-start gap-4">
          <h1 data-aos="zoom-in" className="text-red-500 dark:text-red-500">
            OUR SERVICES
          </h1>
          <h1
            data-aos="zoom-in"
            className="text-black text-[40px] font-semibold leading-10 dark:text-slate-600"
          >
            Top real estate <br></br>
            Our best services
          </h1>
        </div>
        <div
          id="service-box"
          className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-center items-center gap-8"
        >
          {services.map((item, index) => (
            ...
            >
              <div className="p-6 rounded-full bg-red-200">
                <item.icon className="text-red-600 size-10 transform hover:scale-105 transition-transform duration-300 cursor-pointer" />
              </div>
